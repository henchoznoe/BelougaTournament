/**
 * File: components/features/admin/team-detail-dialog.tsx
 * Description: Dialog for viewing team details with member list and admin actions (kick, promote, dissolve).
 * Author: Noé Henchoz
 * License: MIT
          ...
          <div className="space-y-1">
            {team.members.map(member => {
              ...
              const isConfirmingPromote =
                confirmPromoteUserId === member.user.id
                      ...
                      !isConfirmingPromote && (
                        <div className="flex items-center gap-1">
                          <Button
                            ...
                            size="icon-sm"
                            onClick={() =>
                              setConfirmPromoteUserId(member.user.id)
                            }
                            disabled={isPending}
          ...
          {confirmDissolve ? (
            <div className="space-y-2">
              <p className="text-xs text-red-400">
                ...
                {team.members.length}) seront désinscris du tournoi. Cette
