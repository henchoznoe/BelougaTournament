/**
 * File: components/features/admin/sponsor-form.tsx
 * Description: Form component for creating or editing a sponsor with multi-image upload.
 * Author: Noé Henchoz
 * License: MIT
...
export const SponsorForm = ({ sponsor }: SponsorFormProps) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="rounded-2xl border border-white/5 bg-white/2 p-6 backdrop-blur-sm">
        ...
        <div className="mt-4 space-y-2 rounded-xl border border-white/5 bg-white/2 p-3">
          <button
            type="button"
      ...
      <div className="flex items-center justify-end gap-3">
        <Button
          type="button"
          variant="ghost"
          onClick={() => router.push(ROUTES.ADMIN_SPONSORS)}
