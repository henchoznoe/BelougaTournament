...
const STAT_CARDS = [
  {
    ...
    getDetail: (s: DashboardStats) =>
      `${s.users.players} joueur${pluralize(s.users.players)} · ${s.users.admins} admin${pluralize(s.users.admins)} · ${s.users.superAdmins} super admin${pluralize(s.users.superAdmins)} · ${s.users.banned} banni${pluralize(s.users.banned)}`,
