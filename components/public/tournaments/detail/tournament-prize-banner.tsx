...
export const TournamentPrizeBanner = ({
  ...
  return (
    <div
      className={cn(
        'relative overflow-hidden rounded-3xl border border-amber-500/20 bg-linear-to-r from-amber-500/10 via-yellow-500/5 to-amber-500/10',
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-3 text-center">
        <div
          className={cn(
            'inline-flex rounded-full bg-amber-500/10 ring-1 ring-amber-500/20',
            compact ? 'p-2' : 'p-3',
          )}
        >
          <Trophy
            className={cn(compact ? 'size-5' : 'size-6', 'text-amber-400')}
          />
        </div>
        <h3
          className={cn(
            'font-paladins tracking-wider text-amber-300 drop-shadow-[0_0_10px_rgba(245,158,11,0.3)]',
