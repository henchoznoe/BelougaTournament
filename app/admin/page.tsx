      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-white/10 bg-zinc-900/50 backdrop-blur-xl shadow-xl">
          ...
          <CardContent>
            ...
            <p className="text-xs text-zinc-500 mt-1">Joueurs uniques</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-white/10 bg-zinc-900/50 backdrop-blur-xl shadow-xl">
          ...
          <CardContent>
            ...
            <p className="text-xs text-zinc-500 mt-1">Gestionnaires du site</p>
          </CardContent>
        </Card>
      </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="size-10 rounded-lg bg-zinc-800 flex items-center justify-center font-bold text-zinc-400">
                        {(reg.teamName || reg.players[0]?.nickname || '?')
                          .charAt(0)
                          .toUpperCase()}
                      </div>
                      <div>
                    ...
                    <div className="text-xs text-zinc-500 flex flex-col items-end gap-1">
                      ...
                      <Button
                        ...
                        asChild
                      >
                        <Link href={`/admin/tournaments/${reg.tournamentId}`}>
                          Voir
