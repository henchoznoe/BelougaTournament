          ...
          <TableBody>
            {tournaments.length > 0 ? (
              tournaments.map((tournament) => (
                <TableRow key={tournament.id} className="border-zinc-800 hover:bg-zinc-900/50">
                  <TableCell className="font-medium text-white">{tournament.title}</TableCell>
                  <TableCell className="text-zinc-300">
                    {new Date(tournament.startDate).toLocaleDateString()}
                  </TableCell>
                  <TableCell className="text-zinc-300">{tournament.format}</TableCell>
                  <TableCell className="text-zinc-300">
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-2">
                      <Button asChild variant="ghost" size="icon" className="h-8 w-8 text-blue-400 hover:text-blue-300 hover:bg-blue-900/20">
