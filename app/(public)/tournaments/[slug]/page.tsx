                                ...
                                {tournament.challongeId ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center rounded-2xl border border-white/10 bg-zinc-900/50 p-12 text-center backdrop-blur-sm">
                                        ...
                                        <p className="mt-2 text-zinc-400">
                                            L'arbre du tournoi n'a pas encore
                                            été publié.
                                        </p>
                                    </div>
                                )}
                            ...
                            <TabsContent value="stream" className="mt-6">
                                {tournament.streamUrl ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center rounded-2xl border border-white/10 bg-zinc-900/50 p-12 text-center backdrop-blur-sm">
                                        ...
                                        <p className="mt-2 text-zinc-400">
                                            Aucun stream n'est configuré pour ce
                                            tournoi pour le moment.
                                        </p>
                                    </div>
                                )}
                            </TabsContent>
                        ...
                        <div className="sticky top-24 space-y-6">
                            ...
                            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 backdrop-blur-sm">
                                ...
                                <p className="text-sm text-zinc-400 mb-4">
                                    Rejoignez notre Discord pour contacter les
                                    administrateurs du tournoi.
                                </p>
