/**
 * File: app/(public)/players/[id]/loading.tsx
 * Description: Route-level loading skeleton for the player profile page.
 * Author: Noé Henchoz
 * License: MIT
...
const PlayerProfileLoadingPage = () => {
  return (
...
export default PlayerProfileLoadingPage
